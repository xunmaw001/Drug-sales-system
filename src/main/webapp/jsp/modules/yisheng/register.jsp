	...
	<div class="container">
		...
		<div class="" id="login-wrapper">
			...
			<form id="registerForm" action="" method="post">
							...
							<input type="text" name="yishengzhanghao" placeholder="医生账号" class="form-control-i">
							</div>
																								<div class="form-group">
							...
							<input type="text" name="yishengxingming" placeholder="医生姓名" class="form-control-i">
							</div>
																																														<div class="form-group">
							<label class="label">医龄</label> 
							<input type="text" name="yiling" placeholder="医龄" class="form-control-i">
							</div>
																								<div class="form-group">
