...
<body>
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th onclick="sort('yugushouhuoshijian')">预估收货时间<i id="yugushouhuoshijianIcon" class="fa fa-sort"></i></th>
	...
	<script>
		...
		function setDataRow(item,number){
			...
			var yugushouhuoshijianCell  = document.createElement('td');

						  yugushouhuoshijianCell.innerHTML = item.yugushouhuoshijian;


			row.appendChild(yugushouhuoshijianCell);
