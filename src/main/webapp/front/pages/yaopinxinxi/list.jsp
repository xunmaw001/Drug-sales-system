			...
			<div class="data-container layui-row">
				...
				<fieldset class="search-container">
					<form class="layui-form">
							...
							<div class="layui-input-inline">
								<input type="text" name="yaopinfenlei" id="yaopinfenlei" placeholder="药品分类" autocomplete="off" class="layui-input">
							</div>
						</div>   
				...
				function pageList() {
					var param = {
						...
						param['yaopinmingcheng'] = jquery('#yaopinmingcheng').val() ? '%' + jquery('#yaopinmingcheng').val() + '%' : '';
                                                                                ...
                                                                                if (jquery('#yaopinfenlei').val()) {
						param['yaopinfenlei'] = jquery('#yaopinfenlei').val() ? '%' + jquery('#yaopinfenlei').val() + '%' : '';
					}  
